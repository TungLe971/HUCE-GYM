    ...
    <div id="main">
        <div id="header">
            ...
            <div class="menu">
                ...
                <li class="menu-li" style="background-color: rgb(68, 84, 106);"><a class="menu-a" href="../views_thong_ke/thongke_doanhthu.php"><i class="fa-sharp fa-solid fa-money-check"></i> Thống kê</a></li>
            </div>
