    ...
    <div id="main">
        <div id="header">
            ...
            <div class="menu">
                ...
                <li class="menu-li " style="background-color: rgb(68, 84, 106);"><a class="menu-a" href="../../views_nhan_vien/nhan_vien/nhanvien.php"><i class="fa-solid fa-people-roof"></i> Nhân viên</a></li>
